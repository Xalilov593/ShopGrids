        ...
        <div
            ...
            <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
                ...
                <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                    <div class="grow">
                        <h5 class="text-16">Permissions</h5>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-1 gap-5 mb-5 xl:grid-cols-2">
                            ...
                            <div class="ltr:md:text-end rtl:md:text-start">
                                <button type="button" data-modal-target="showModal"
                                        ...
                                        class="align-bottom ri-add-line me-1"></i> Add Permission
                                </button>
                            </div>
                        </div>
                            ...
                            <table class="w-full whitespace-nowrap" id="customerTable">
                                ...
                                @foreach($permissions as $permission=>$value)
                                    <tr>
                                        ...
                                        <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 customer_name">{{++$permission}}</td>
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <form class="tablelist-form"
                                                                      action="{{ route('permissions.update', $value->id) }}"
                                                                      method="POST"
                                                                      {{--                @endforeach--}}
                                                                      id="edit-permission">
                                                                    @csrf
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="customername-field"
                                                                               class="inline-block mb-2 text-base font-medium">Permission
                                                                            Name <span
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="mt-5 text-center">
                                                                    ...
                                                                    <p class="text-slate-500 dark:text-zink-200">Are you
                                                                        certain you want to delete this permission?</p>
    ...
    <div id="showModal" modal-center=""
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                <form class="tablelist-form" action="{{route('permissions.store')}}" method="POST">
                    @csrf

                    <div class="mb-3">
                        <label for="customername-field" class="inline-block mb-2 text-base font-medium">Permission Name
