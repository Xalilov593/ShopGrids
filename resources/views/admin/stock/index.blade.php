...
@section('content')
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
                            ...
                            <ul class="flex flex-wrap w-full gap-2 text-sm font-medium text-center filter-btns grow"
                                ...
                                <li>
                                    <a href="javascript:void(0);" data-filter="entry"
                                       class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 dark:text-zink-200 border border-transparent filter-btn filter-btn-active:bg-custom-500 text-white dark:text-white hover:text-custom-500 dark:hover:text-custom-500 -mb-[1px]">Entry
                                        Product</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" data-filter="take"
                                       class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 dark:text-zink-200 border border-transparent filter-btn hover:text-custom-500 dark:hover:text-custom-500 -mb-[1px]">Take
                                        Product</a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="flex gap-3">
                                ...
                                <div class="shrink-0">
                                    <button data-modal-target="addNotesModal" type="button"
                                        ...
                                        <span class="align-middle">Entry Product</span></button>
                                </div>
                            </div>
                        </div><!--end col-->
            ...
            <div class="card" id="entry-product-list">
                <div class="card-body">
                    <h6 class="mb-4 text-15">Entry Products</h6>
                            ...
                            @foreach($stocks as $stock=> $value)
                                <tr>
                                    <td class="px-3.5 py-2.5 border border-custom-500 dark:border-custom-800"><a
                                            href="#!"
                                            class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600">{{$value->product->name}}</a>
                                    </td>
                                    <td class="px-3.5 py-2.5 border border-custom-500 dark:border-custom-800">
                                        @if($value->type=="in")
                                            <i class="ri-arrow-down-line"></i>
                                        @else
                                            <i class="arrow-up-right"></i>
                                        @endif
                                    </td>
                                    <td class="px-3.5 py-2.5 border border-custom-500 dark:border-custom-800">
                                        {{$value->quantity}}
                                        ...
                                        <div class="flex gap-2">
                                            <div class="edit">
                                                <a type="button" data-modal-target="editModal{{$value->id}}"
                                                   ...
                                                   data-bs-target="#editModal{{$value->id}}">Edit
                                                </a>
                                                <div id="editModal{{$value->id}}" modal-center=""
                                                    ...
                                                    <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
                                                        ...
                                                        <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                                                            <form action="{{route('stock.update', $value->id)}}"  method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                                <div class="mb-3">
                                                                    <label for="productSelect" class="inline-block mb-2 text-base font-medium">Product</label>
                                                                    <select
                                                                    ...
                                                                    <label for="productSelect" class="inline-block mb-2 text-base font-medium">Type</label>
                                                                    <select
                                                                        class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                                        name="type" id="productSelect">
                                                                        <option value="in">Entry Product</option>
                                                                        <option value="out">Take Product</option>
                                                                    </select>

                                                                    <div>
                                                                        <label for="quantity" class="inline-block mb-2 text-base font-medium">Quantity <span
                                            ...
                                            <form action="{{route('stock.destroy', $value->id)}}" method="POST">
                                                @csrf
                                                @method('delete')
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="mt-5 text-center">
                                                                ...
                                                                <p class="text-slate-500 dark:text-zink-200">Are you
                                                                    certain you want to delete this stock?</p>
    ...
    <div id="addNotesModal" modal-center=""
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            <div class="flex items-center justify-between p-4 border-b dark:border-zink-300/20">
                <h5 class="text-16">Entry Product</h5>
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form action="{{route('stock.store')}}"  method="POST">
                    ...
                    {{--                        <select class="form-input border-slate-300 focus:outline-none focus:border-custom-500" name="category" id="categorySelect">--}}
