...
@section('content')
                                ...
                                <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                                    <div class="xl:col-span-4">
                                        <ul class="flex flex-wrap w-full gap-2 text-sm font-medium text-center filter-btns grow"
                                            ...
                                            <li>
                                                <a href="{{route('cities.index')}}" data-filter="business"
                ...
                <div class="card-body">
                    <div class="grid grid-cols-1 gap-5 mb-5 xl:grid-cols-2">
                        ...
                        <div class="ltr:md:text-end rtl:md:text-start">
                            <button type="button" data-modal-target="addModal"
                                    ...
                                    class="align-bottom ri-add-line me-1"></i> Add Region
                            </button>
                        </div>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                        <div class="flex gap-2">
                                            <div class="edit">
                                                <button data-modal-target="editRegion{{$value->id}}"
                                                ...
                                                <div id="editRegion{{$value->id}}" modal-center=""
                                                     class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show">
                                                    <div
                                                        class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
                                                        <div
                                                            class="flex items-center justify-between p-4 border-b border-slate-200 dark:border-zink-500">
                                                            <h5 class="text-16" id="exampleModalLabel">Edit Region</h5>
                                                            <button data-modal-close="editRegion{{$value->id}}"
                                                        ...
                                                        <div
                                                            ...
                                                            <form class="tablelist-form"
                                                                  action="{{route('regions.update', $value->id)}}"
                                                                  method="post">
                                                                @csrf
                                                                @method('PUT')
                                                                ...
                                                                <div class="flex justify-end gap-2">
                                                                    <button type="button"
                                                                            data-modal-close="editRegion{{$value->id}}"
                                            ...
                                            <div class="remove">
                                                <button data-modal-target="deleteModal{{$value->id}}" id="delete-record"
                                                ...
                                                <form action="{{route('regions.destroy', $value->id)}}" method="POST">
                                                    @csrf
                                                    @method('delete')
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="mt-5 text-center">
                                                                    ...
                                                                    <p class="text-slate-500 dark:text-zink-200">Are you
                                                                        certain you want to delete this region?</p>
    ...
    <div id="addModal" modal-center=""
         class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show">
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            <div class="flex items-center justify-between p-4 border-b border-slate-200 dark:border-zink-500">
                <h5 class="text-16" id="exampleModalLabel">Add Region</h5>
                <button data-modal-close="addModal"
                        class="transition-all duration-200 ease-linear text-slate-400 hover:text-slate-500">
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                <form class="tablelist-form" action="{{route('regions.store')}}" method="post">
                    @csrf
                    <div class="mb-3" id="modal-id" style="display: none;">
                    ...
                    <div class="mb-3">
                        <label for="customername-field" class="inline-block mb-2 text-base font-medium">Region Name
                            <span class="text-red-500">*</span></label>
                    ...
                    <div class="flex justify-end gap-2">
                        <button type="button" data-modal-close="addModal"
                                class="text-white btn bg-slate-500 border-slate-500 hover:text-white hover:bg-slate-600 hover:border-slate-600 focus:text-white focus:bg-slate-600 focus:border-slate-600 focus:ring focus:ring-slate-100 active:text-white active:bg-slate-600 active:border-slate-600 active:ring active:ring-slate-100 dark:ring-slate-400/10">
                            Close
                        </button>
                        <button type="submit" data-modal-close="addModal"
                                class="text-white bg-green-500 border-green-500 btn hover:text-white hover:bg-green-600 hover:border-green-600 focus:text-white focus:bg-green-600 focus:border-green-600 focus:ring focus:ring-green-100 active:text-white active:bg-green-600 active:border-green-600 active:ring active:ring-green-100 dark:ring-green-400/10"
                                id="add-btn">Add Region
                        </button>
                    </div>
                </form>
            </div>
